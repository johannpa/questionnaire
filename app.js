...
function genererListeOranges(){
    ...
    orangeHtml.innerHTML = genererListe(panier.oranges);
}
...
function verifierResultatOrange() {
    ...
    if (poidsTotalMachine === parseInt(poidsValeur) && prixTotalMachine === parseInt(prixValeur)) {
        sectionResultat.innerHTML = "<img src = \"./img/check.gif\" width = '30'/>";
        finOrange = true;
        finDuJeu();
    } else {
        sectionResultat.innerHTML = "<img src = \"./img/croix.png\" width = '30'/>";
    }
}
